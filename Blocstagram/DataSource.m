...
@property (nonatomic, assign) BOOL isLoadingOldItems;
@property (nonatomic, assign) BOOL thereAreNoMoreMessages;
...
- (void) registerForAccessTokenNotification {
    [[NSNotificationCenter defaultCenter] addObserverForName:LoginViewControllerDidAccessTokenNotification object:nil queue:nil usingBlock:^(NSNotification *note) {
...
#pragma mark - Instagram Client ID
+ (NSString *) instagramClientID {
    return @"319169be525542ab8d0f7a728be49201";
}
...
- (void) requstNewItemsWithCompletionHandler:(NewItemCompletionBlock)completionHandler {
    ...
    if (self.isRefreshing == NO) {
        ...
        NSString *mindID = [[self.mediaItems firstObject] idNumber];
        NSDictionary *parameters;
        
        if (mindID) {
            parameters = @{@"min_id":mindID};
        }
...
#pragma mark - oldItemRequest

- (void) requstOldItemWithCompletionHandler:(NewItemCompletionBlock)completionHandler {
    self.thereAreNoMoreMessages = NO;
    
    if (self.isLoadingOldItems == NO && self.thereAreNoMoreMessages == NO) {
        self.isLoadingOldItems = YES;
...
#pragma mark - populateDataWithParameter
...
- (void) parseDataFromFeedDictionary:(NSDictionary *) feedDictionary fromRequestWithParameters:(NSDictionary *)parameters {
    ...
    if (parameters[@"min_id"]) {
        ...
        if (tmpMediaItems.count == 0) {
            ...
            self.thereAreNoMoreMessages = YES;
        } else {
