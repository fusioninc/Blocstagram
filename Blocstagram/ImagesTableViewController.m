...
@property (nonatomic, strong)UIView *lastSelectedCommentView;
...
- (void) imageLibraryViewController:(ImageLibraryViewController *)imageLibraryViewController didCompleteWithImage:(UIImage *)image {
    ...
    [self handleIamge:image withNavigationController:imageLibraryViewController.navigationController];
}

- (void) cameraViewController:(CameraViewController *)cameraViewController didCompleteWithImage:(UIImage *)image {
    
    [self handleIamge:image withNavigationController:cameraViewController.navigationController];

}

#pragma mark - PostoInstagramViewController

- (void) handleIamge:(UIImage *)image withNavigationController:(UINavigationController *)nav {
