...
- (instancetype) initWithImage:(UIImage *)sourceImage {
    ...
    if (self) {
        ...
        self.filterImages = [NSMutableArray arrayWithObjects:sourceImage, nil];
...
/*
The collection view will always have only one section, so we don't need to implement numberOfSectionsInCollectionView:. The number of items will always be equal to the number of filtered images available:
 */
...
- (void)addCIImageToCollectionView:(CIImage *)CIImage withFilterTitle:(NSString *)filterTitle {
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (boomFilter) {
            [boomFilter setValue:_sourceImage forKey:kCIInputImageKey];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (warmFilter) {
            [warmFilter setValue:_sourceImage forKey:kCIInputImageKey];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (pixelFilter) {
            [pixelFilter setValue:_sourceImage forKey:kCIInputImageKey];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (moodyFilter) {
            [moodyFilter setValue:_sourceImage forKey:kCIInputImageKey];
