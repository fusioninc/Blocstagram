...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[UICollectionViewFlowLayout class] forCellWithReuseIdentifier:@"cell"];
...
/*
 To make the scrolling smoother, we'll get the image asynchronously and update the cell's image view when it arrives.
 */
